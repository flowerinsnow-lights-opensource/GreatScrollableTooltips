...
public class GreatScrollableTooltips {
    ...
    public void onClientSetup(FMLClientSetupEvent event) {
        ...
        ModLoadingContext.get().registerExtensionPoint(ConfigGuiHandler.ConfigGuiFactory.class, () ->
            new ConfigGuiHandler.ConfigGuiFactory((client, parent) -> new ConfigScreen(parent, GreatScrollableTooltips.this.config))
        );
        ...
        ClientRegistry.registerKeyBinding(GreatScrollableTooltips.KEY_BINDING_SCROLL_UP.get());
        ClientRegistry.registerKeyBinding(GreatScrollableTooltips.KEY_BINDING_SCROLL_DOWN.get());
        ClientRegistry.registerKeyBinding(GreatScrollableTooltips.KEY_BINDING_SCROLL_LEFT.get());
        ClientRegistry.registerKeyBinding(GreatScrollableTooltips.KEY_BINDING_SCROLL_RIGHT.get());
    }
